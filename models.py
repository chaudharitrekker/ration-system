...
class OfficerDemand(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    employee_number = db.Column(db.String(50), nullable=False)  # Officer P.No
    ...
    rik_gx_file = db.Column(db.String(200))  # filename, optional
    ...
    availability_days = db.Column(db.Integer, nullable=True)
